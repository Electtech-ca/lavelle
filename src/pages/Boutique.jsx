...
export default function Boutique() {
  ...
  return (
    <>
      ...
      {/* Fashion grid */}
      <div style={{ background: 'var(--lavelle-ivory)', padding: 'var(--space-lg) var(--space-xl)', minHeight: '60vh' }}>
        <div className="container">
          ...
          {loading ? (
            <div style={{ textAlign: 'center', padding: 'var(--space-3xl) 0' }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem', fontStyle: 'italic', color: 'var(--lavelle-plum-soft)' }}>{t('app.loadingCollection')}</p>
            </div>
          ) : (
