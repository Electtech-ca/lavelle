export const promotions = [
  { id: 1, title: 'New Member Welcome Gift',       value: '$75 value',        expiry: 'Ongoing',        description: 'First-time clients receive a complimentary Sparivier Mini Gift Set with first booking over $144.' },
  ...
  { id: 4, title: "Wednesday Women's Luncheon",    value: '$66 fixed menu',   expiry: 'Weekly',         description: 'Every Wednesday, a 3-course prix fixe lunch for the Sparivier Woman. Reserve by Tuesday.' },
  ...
  { id: 6, title: 'The Quarterly Sparivier Box',    value: '$264 for $192',    expiry: 'Subscribe',      description: 'Curated box of 6 full-size luxury products. Delivered quarterly to members.' },
...
export const loyaltyTiers = [
  ...
  { tier: 'Diamond',   emoji: '💎', range: '2,001+ points',  benefits: ['All Gold benefits', 'Annual complimentary Royal Indulgence Spa Package', 'Personal style consultation with Donna', 'Exclusive invitation to Sparivier members-only events'] },
]
